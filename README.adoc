...
----
{
  ...
  "scores": [
    ...
    },
    {
      ...
      "testCase": "testFarthestNorthRandom",
      "passed": true,
      "pointsPossible": 10,
      "pointsEarned": 10,
      "description": "testFarthestNorthRandom",
      "explanation": "testFarthestNorthRandom passed",
      "type": "test"
    },
    {
      "difficulty": "simple",
    ...
    },
    {
      ...
      "module": "lib",
      "className": "edu.illinois.cs.cs125.spring2019.mp0.lib.LocatorTest",
      "testCase": "testNextRandomLocationRandom",
      "passed": true,
      "pointsPossible": 10,
      "pointsEarned": 10,
      "description": "testNextRandomLocationRandom",
      "explanation": "testNextRandomLocationRandom passed",
      "type": "test"
    },
    {
      "difficulty": "simple",
      ...
      "module": "lib",
      "className": "edu.illinois.cs.cs125.spring2019.mp0.lib.LocatorTest",
      "testCase": "testNextRandomLocationSimple",
      "passed": true,
      "pointsPossible": 10,
      "pointsEarned": 10,
      "description": "testNextRandomLocationSimple",
      "explanation": "testNextRandomLocationSimple passed",
      "type": "test"
    },
    {
      "difficulty": "random",
      ...
      "module": "lib",
      "className": "edu.illinois.cs.cs125.spring2019.mp0.lib.LocatorTest",
      "testCase": "testBeenHereRandom",
      "passed": true,
      "pointsPossible": 10,
      "pointsEarned": 10,
      "description": "testBeenHereRandom",
      "explanation": "testBeenHereRandom passed",
      "type": "test"
    },
    {
      "difficulty": "simple",
