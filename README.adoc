...
buildscript {
    ...
    dependencies {
        classpath 'com.github.cs125-illinois:gradlegrader:2020.1.2'
    }
}
...
a dependency to the project(s) containing graded test suites:
    ...
    testImplementation 'com.github.cs125-illinois:gradlegrader:2020.1.2'
...
If you are using a Kotlin buildscript or would like to use the new `plugins` block
